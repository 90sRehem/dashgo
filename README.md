...
* Esse projeto foi desenvolvido durante um dos capitulos do Bootcamp Ignite da Rocketseat! A ideia era desenvolver um dashboard usando o Chakra UI, também deixando a aplicação responsiva.
...
$ git clone https://github.com/90sRehem/dashgo.git
```
...
Este projeto está licenciado sob a Licença MIT. Veja o arquivo de [LICENÇA](https://github.com/90sRehem/dashgo/blob/main/LICENSE) para detalhes.
